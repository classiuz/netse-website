...
export default function Header() {
  ...
  return (
    <header className="mx-auto px-2 flex h-[calc(100vh-100px)] w-full items-center md:w-8/12">
      <div className="md:gap-18 flex flex-col gap-12 lg:gap-24">
        <p className={`${notoSans.className} text-center text-5xl text-neutral-700 lg:text-6xl`}>#Generando Vínculos</p>
        <ul className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:text-center xl:grid-cols-4">
          ...
          <HeaderCard
            iconName="wifi"
            text="Nos ocupamos de la conectividad y transmisión de datos en lugares remotos."
          />
          <HeaderCard
            iconName="work"
          ...
          <HeaderCard
            iconName="tag"
            text="Nos enfocamos en las unidades de negocio Comercios y Empresas, Minería y Petróleo."
          />
        </ul>
      </div>
